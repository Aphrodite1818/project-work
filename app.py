...
# Display Image & Title
st.image("https://th.bing.com/th/id/OIP.dqbAKjT-9DyP-z8VxzV_dgHaFn?rs=1&pid=ImgDetMain", width=800)
...
with st.form("prediction_form"):
    ...
    YearBuilt = st.slider("🏗️ Select Year Built", min_value=1900, max_value=2023, step=1)
